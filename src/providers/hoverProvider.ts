...
export class EJSHoverProvider implements vscode.HoverProvider {
   ...
   */
  private createHoverContent(definition: any, document: vscode.TextDocument): vscode.MarkdownString {
    ...
    if (definition.declarationType) {
      const declarationInfo = this.getDeclarationTypeInfo(definition.declarationType);
